 ...
 */
public class MasterDataCache implements AutoCloseable {
    private static final Logger LOGGER = LoggerFactory.getLogger(MasterDataCache.class);
    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    
    private final MasterDataCacheConfig config;
    private final DynamoDbClient dynamoDbClient;
    private final CloseableHttpClient httpClient;

    /**
     * Creates a new MasterDataCache with the specified configuration.
     *
     * @param config The configuration
     */
    public MasterDataCache(MasterDataCacheConfig config) {
        this.config = config;
