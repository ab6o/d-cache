...
import com.github.httpcache.dynamodb.serializer.CacheEntrySerializer;
import com.github.httpcache.dynamodb.serializer.JsonCacheEntrySerializer;

/**
 * Configuration options for MasterDataCache.
 */
public class MasterDataCacheConfig {
    ...
    private MasterDataCacheConfig(Builder builder) {
    ...
    /**
     * Builder for MasterDataCacheConfig.
     */
    public static class Builder {
        private String tableName = "master-data-cache";
        ...
        public Builder withDynamoDbClient(AmazonDynamoDB dynamoDbClient) {
        ...
        public MasterDataCacheConfig build() {
            if (dynamoDbClient == null) {
                throw new IllegalArgumentException("DynamoDB client must be provided");
            }
            return new MasterDataCacheConfig(this);
        }
    }
} 